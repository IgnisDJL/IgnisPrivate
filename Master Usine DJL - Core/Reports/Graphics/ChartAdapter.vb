...
Public MustInherit Class ChartAdapter
    ...
    Protected chartArea As ChartArea
    Private _mainDataSerie As Serie

    Protected Sub New()

        Me.chart = New Chart()
        Me.chartArea = New ChartArea("default")
        Me._mainDataSerie = New Serie
    ...
    Protected Overridable Sub consolidate()
        ...
        If (Me.MAIN_DATA_SERIE.Points.Count > 0 OrElse Not IsNothing(Me.chart.DataSource)) Then
