...
Public Class CSVFile
    ...
    ' #language
    Public Shared ReadOnly GENERIC_NAME As String = "Fichier de données (.csv)"

    ' Attributes
    Private _date As Date

    ' Events
    Public Event AnalysisStartedEvent(csvFile As CSVFile)
    Public Event AnalysisProgress(current As Integer, total As Integer)
    Public Event AnalysisStopedEvent(csvFile As CSVFile)
    ...
    Public Overrides Function getCycles(startTime As Date, endTime As Date) As List(Of Cycle)
        ...
        Dim fileDate = getDateFromFileName(Me.getFileInfo.Name)
        ...
        For i = 1 To nbRowsToAnalyse
            ...
            RaiseEvent AnalysisProgress(i, nbRowsToAnalyse)
