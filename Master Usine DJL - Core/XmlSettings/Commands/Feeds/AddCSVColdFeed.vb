    ...
    Public Class AddCSVColdFeed
        ...
        Public Overrides Sub execute()
            ...
            If (IsNothing(Me.newFeedInfo)) Then
                Me.newFeedInfo = XmlSettings.Settings.instance.Usine.DataFiles.CSV.addColdFeedInfo(Me.newLocation, Me.newMaterial, Me.newIndex, Me.newIsRecycled)
            Else
                XmlSettings.Settings.instance.Usine.DataFiles.CSV.addColdFeedInfo(Me.newFeedInfo)
            End If
        ...
        Public Overrides Sub undo()
            ...
            XmlSettings.Settings.instance.Usine.DataFiles.CSV.removeColdFeedInfo(Me.newFeedInfo)
