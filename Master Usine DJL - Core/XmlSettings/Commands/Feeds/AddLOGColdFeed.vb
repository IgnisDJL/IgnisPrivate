    ...
    Public Class AddLOGColdFeed
        ...
        Public Overrides Sub execute()
            ...
            If (IsNothing(Me.newFeedInfo)) Then
                Me.newFeedInfo = XmlSettings.Settings.instance.Usine.DataFiles.LOG.addColdFeedInfo(Me.newLocation, Me.newMaterial, Me.newIndex, Me.newIsRecycled, Me.newIsFiller)
            Else
                XmlSettings.Settings.instance.Usine.DataFiles.LOG.addColdFeedInfo(Me.newFeedInfo)
            End If
        ...
        Public Overrides Sub undo()
            ...
            XmlSettings.Settings.instance.Usine.DataFiles.LOG.removeColdFeedInfo(Me.newFeedInfo)
