Namespace UI
    ...
    Public Class MixSettingsView
        Inherits SettingsView

        ' Constants
        Public Shared ReadOnly VIEW_NAME As String = "Enrobés"


        ' Components
        ' !LAYOUT!
        Private catalog As MixListView
        ...
        Protected Overrides Sub initializeComponents()
            ...
            Me.catalog = New MixListView(Plant.mixCatalog)
