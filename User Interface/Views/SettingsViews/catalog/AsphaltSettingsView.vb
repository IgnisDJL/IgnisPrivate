Namespace UI
    ...
    Public Class AsphaltSettingsView
        Inherits SettingsView

        ' Constants
        Public Shared ReadOnly VIEW_NAME As String = "Bitumes"


        ' Components
        ' !LAYOUT!
        Private catalog As AsphaltListView
        ...
        Protected Overrides Sub initializeComponents()
            ...
            Me.catalog = New AsphaltListView(Plant.feederCatalog)
