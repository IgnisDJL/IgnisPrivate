Namespace UI
    Public Class AsphaltListView
        ...
        Private grade As UI.Common.TextField
        ...
        Private Sub InitializeComponent()
            ...
            Dim columnGrade = New DataGridViewTextBoxColumn()
            columnGrade.HeaderText = "Grade"
            columnGrade.Width = 100
            ...
            gridViewContainer.Columns.Add(columnGrade)
            ...
            Dim columnGrade_containerItem = New DataGridViewTextBoxColumn()
            columnGrade_containerItem.HeaderText = "Grade"
            columnGrade_containerItem.Width = 100
            ...
            gridViewContainerItem.Columns.Add(columnGrade_containerItem)
            ...
            Me.grade = New UI.Common.TextField
            ...
            Me.grade.Location = New Point(Me.newCatalogContainerId.Location.X + Me.newCatalogContainerId.Width + 20, Me.newCatalogContainerId.Location.Y)
            Me.grade.Size = New Size(150, LayoutManager.FIELDS_HEIGHT)
            Me.grade.PlaceHolder = "Grade"

            Me.newEffectiveDate.Location = New Point(Me.grade.Location.X + Me.grade.Width + 5, Me.grade.Location.Y)
        ...
        Private Sub btn_CatalogContainerAdd_Click(sender As Object, e As EventArgs) Handles btn_CatalogContainerAdd.Click
            ...
            listviewItem.SubItems.Add(grade.Text)
            catalogContainer.addNewContainerToCatalog(newCatalogContainerId.Text, newEffectiveDate.StartDate, grade.Text)
            fillCatalogContainerItem()
