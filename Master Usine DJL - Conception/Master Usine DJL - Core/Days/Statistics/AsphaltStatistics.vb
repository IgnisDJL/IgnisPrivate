...
Public Class AsphaltStatistics
    ...
    Public Overrides Sub addCycle(cycle As Cycle, dataFileNode As DataFileNode)
        ...
        If (Not TypeOf cycle Is LOGCycle Or cycle.PRODUCTION_SPEED > 0) Then
            ...
            Me.CYCLE_ASPHALT_MASS = dataFileNode.getUnitByTag(cycle.ASPHALT_MASS_TAG).convert(cycle.ASPHALT_MASS, Settings.instance.Report.Word.MASS_UNIT)
            Me.CYCLE_MIX_MASS = dataFileNode.getUnitByTag(cycle.MIX_MASS_TAG).convert(cycle.MIX_MASS, Settings.instance.Report.Word.MASS_UNIT)
            Me.CYCLE_TEMPERATURE = dataFileNode.getUnitByTag(cycle.TEMPERATURE_TAG).convert(cycle.TEMPERATURE, Settings.instance.Report.Word.TEMPERATURE_UNIT)
    ...
    Public WriteOnly Property CYCLE_TEMPERATURE As Double
        Set(value As Double)
            ...
            ' #settings
            If (Me.SET_POINT_TEMPERATURE > Celsius.UNIT.convert(0, Settings.instance.Report.Word.TEMPERATURE_UNIT)) Then

                If (value > Me.SET_POINT_TEMPERATURE + Celsius.UNIT.unitConvert(7, Settings.instance.Report.Word.TEMPERATURE_UNIT)) Then
            ...
            Else
                ...
                If (value > Celsius.UNIT.convert(170, Settings.instance.Report.Word.TEMPERATURE_UNIT)) Then
                    Me.nbCycleAboveTempLimit += 1
                    isOutLimitCycle = True
                End If
    ...
    Public ReadOnly Property BELOW_TEMPERATURE_LIMIT_PERCENTAGE As Double
        Get
            Return PerOne.UNIT.convert(Me.nbCycleBelowTempLimit / Me.CYCLES.Count, Settings.instance.Report.Word.PERCENT_UNIT)
        End Get
    End Property
    ...
    Public ReadOnly Property ABOVE_TEMPERATURE_LIMIT_PERCENTAGE As Double
        Get
            Return PerOne.UNIT.convert(Me.nbCycleAboveTempLimit / Me.CYCLES.Count, Settings.instance.Report.Word.PERCENT_UNIT)
        End Get
    End Property
