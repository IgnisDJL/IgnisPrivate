Public Class RecycledPercentageGraphic
    ...
    Public Overrides Sub addCycle(cycle As Cycle, dataFileNode As DataFileNode)
        ...
        Dim lastPointFormat = Graphic.pointFormatList_mix.getFormatFor(cycle.MIX_NAME, cycle.ASPHALT_NAME)
    ...
    Private Sub buildLegend()
        ...
        Dim pointsFormats = Graphic.pointFormatList_mix.getAllFormats
