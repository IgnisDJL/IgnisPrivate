...
Public Class AccumulatedMassGraphic
    ...
    Public Property UNIT As Unit = XmlSettings.Settings.instance.Report.Word.MASS_UNIT
    ...
    Public Sub New(Optional isHybrid As Boolean = False)
        MyBase.New()
    ...
    Public Overrides Sub addCycle(cycle As Cycle, dataFileNode As DataFileNode)
        ...
        Dim cycleTons = dataFileNode.getUnitByTag(cycle.MIX_ACCUMULATED_MASS_TAG).convert(cycle.MIX_ACCUMULATED_MASS, Me.UNIT)
