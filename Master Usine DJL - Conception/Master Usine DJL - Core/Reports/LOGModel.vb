...
Public Class LOGModel
    ...
    Private specialSettings As XmlSettings.Settings = Nothing
    ...
    Public Overrides Function generateModel() As Microsoft.Office.Interop.Excel.Workbook
        ...
        If (LOGModel.fileExists) Then
            ...
            Do
                ...
                Try
                    ...
                    System.IO.File.Delete(Constants.Paths.LOG_MODEL)
        ...
        Dim sheetSettings = XmlSettings.Settings.instance.Report.Excel.LOG_SHEET
        ...
        Me.saveAs(xlsWorkbook, Constants.Paths.LOG_MODEL, Constants.Output.Excel.REPORT_EXTENSION)
    ...
    Public Shared Function fileExists() As Boolean
        Return System.IO.File.Exists(Constants.Paths.LOG_MODEL)
    End Function
