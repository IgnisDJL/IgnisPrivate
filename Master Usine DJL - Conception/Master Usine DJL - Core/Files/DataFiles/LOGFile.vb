...
Public Class LOGFile
    ...
    ' #language
    Public Shared ReadOnly GENERIC_NAME As String = "Fichier de données (.log)"

    ' Attributes
    Private _date As Date

    ' Events
    Public Event AnalysisStartedEvent(logFile As LOGFile)
    Public Event AnalysisProgress(current As Integer, total As Integer)
    Public Event AnalysisStopedEvent(logFile As LOGFile)
    ...
    Public Overrides Function getCycles(startTime As Date, endTime As Date) As List(Of Cycle)
        ...
        For i = 1 To nbTablesToAnalyse
            ...
            RaiseEvent AnalysisProgress(i, nbTablesToAnalyse)
            ...
            Try
                ...
                For j = 1 To feedsLocations.Count - 1
                    ...
                    '    logNode.addUnknownFeed(currentFeed.LOCATION, currentFeed.MATERIAL_NAME, MasterUsine.Cycle.COLD_FEED_TAG)
                    'End If
